...
function Bee_Honey_GetDefense():Number
{
	// NOTE: You can't use "i" here for the index number of _GAME_Items. Use the item ID.
	//       Find it in ...\CoC_Game\Items\ItemList.as
...
function Bee_Honey_GetArmour():Number
{
	// NOTE: You can't use "i" here for the index number of _GAME_Items. Use the item ID.
	//       Find it in ...\CoC_Game\Items\ItemList.as
...
function Bee_Honey_ApplyPassive()
{
	// NOTE: You can't use "i" here for the index number of _GAME_Items. Use the item ID.
	//       Find it in ...\CoC_Game\Items\ItemList.as
...
_GAME_Items[i].Use = Bee_Honey_Use; // Setting the function of the item when used.
_GAME_Items[i].GetItemDamage = Bee_Honey_GetDamage; // Setting the get damage function of the item.
_GAME_Items[i].GetItemDefense = Bee_Honey_GetDefense; // Setting the get defense function of the item.
_GAME_Items[i].GetItemArmour = Bee_Honey_GetArmour; // Setting the get armour function of the item.
_GAME_Items[i].ApplyPassive = Bee_Honey_ApplyPassive; // Setting the function of the item's passive.